...
public class SirAlfredLobby : MonoBehaviour 
{
    ...
    [Space]
    [Tooltip("This is for EditorStarting only! Game will load this Scene on Editor Startup if only one Scene is opened.")]
    [SerializeField] SceneReference lobbyUIScene = null;
    [Space]
    ...
    private void Start()
    {
        ...
        {
            SceneManager.Instance.LoadUIAdditive(lobbyUIScene);
        }
#endif
    ...
    void SetupPlayerConfigs()
    {
        ...
        // Setup AI Players and populate the field with untaken roles & colors
